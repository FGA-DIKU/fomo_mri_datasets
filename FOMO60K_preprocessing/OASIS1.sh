...
usage() {
    ...
    echo ""
    echo "Process OASIS1 dataset with preprocessing pipeline"
    echo ""
    echo "Options:"
    echo "  -i: Input root directory containing OASIS1 subject/session folders"
    echo "  -o: Output root directory for preprocessed OASIS1 data"
    echo "  -t: Number of threads (default: 4)"
    echo "  -f: FreeSurfer home directory (default: \$FREESURFER_HOME)"
    echo "  -h: Show this help message"
    echo ""
    echo "Example:"
    echo "  $0 -i /path/to/oasis1_tmp -o /path/to/oasis1_preprocessed -t 4"
    exit 1
}
...
# Set up FreeSurfer
echo "=================================================="
echo "OASIS1 Dataset Preprocessing Pipeline"
echo "=================================================="
...
# Get all OASIS1 session directories (2 levels deep: subject/session)
echo "Scanning for OASIS1 sessions in: $INPUT_ROOT"
SESSIONS=($(find "$INPUT_ROOT" -mindepth 2 -maxdepth 2 -type d | sort))

# Check if we have sessions
if [ ${#SESSIONS[@]} -eq 0 ]; then
    echo "Error: No OASIS1 sessions found in $INPUT_ROOT"
    echo "Expected structure: $INPUT_ROOT/subject_*/session_*/"
    exit 1
fi

echo "Found ${#SESSIONS[@]} OASIS1 sessions to process"
...
for SESSION_DIR in "${SESSIONS[@]}"; do
    echo "Processing OASIS1 session: $SESSION_DIR"
...
# Print summary
echo "=================================================="
echo "OASIS1 Processing Complete!"
echo "=================================================="
